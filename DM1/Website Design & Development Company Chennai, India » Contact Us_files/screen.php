...
.title_section h1 { color:#149AB8;font-size:22px; }
#content h1,#content h1 a { color:#149AB8;font-size:22px; }
#content h2,#content h2 a { color:#149AB8;font-size:20px; }
#content h3,#content h3 a { color:#149AB8;font-size:18px; }
#content h4,#content h4 a { color:#149AB8;font-size:16px; }
#content h5,#content h5 a { color:#149AB8;font-size:14px; }
#content h6,#content h6 a { color:#149AB8;font-size:12px; }
#content #sidebar h3 { color:#149AB8;font-size:23px; }
#footer h1, #footer h2, #footer h3, #footer h4, #footer h5, #footer h6,#footer .widget h3 { color:#cccccc;font-size:18px; }
#footer .testimonial_box h5 { color:#cccccc; }
#footer ul li,.large-footer ul li a,#footer .tagcloud a,#footer p,#footer a,#footer .my_toggle .my_toggle_title,#footer .my_tabs ul.tab-nav li a,#footer .testimonials_slider ul li .client_testimonials h5 sub,#footer select,#footer label { color:#aaaaaa;font-size:14px; }
#content .post-title h1,#content .post-title h1 a,#content .post-title h3,#content .post-title h3 a { color:#149AB8;font-size:18px; }
#footer .small_footer ul li a { color:#ffffff;font-size:12px; }
#footer_copyright_info p,#footer_copyright_info p a { color:#000000;font-size:13px; }
...
{ background:#00b6de;  -webkit-box-shadow: inset 0 0 10px #009fc2; -moz-box-shadow: inset 0 0 10px #009fc2; box-shadow: inset 0 0 10px #009fc2; }
...
.swm_portfolio_text .project_title
 { font-family: "Abel", arial, verdana, tahoma; -webkit-text-stroke: 1px transparent;
}p { font-family: "Abel", arial, verdana, tahoma;}
body { font-family: Abel, arial,verdana,helvetica,sans-sarif; }
#content p,p { line-height: 20px}
.top-menu>ul.sf-menu>li>a { font-size:18px; font-family:Abel,arial,verdana,tahoma; }
.top-menu>ul.sf-menu>li>a>small { font-size:14px; }
...
#lang_sel_footer { border:0; margin-bottom:15px; border-top:3px solid #00b6de; }
body { background:#d6d2d2 url(http://symbiosyssoft.com/wp-content/uploads/2013/10/minimal_grunge_3_light1.jpg) fixed center   }.top-menu { margin-top:5px; }.steps_with_circle ol li span
...
{ background:#00b6de; color:#fff; }
.swm_projects_style3_text_wrap,.projects_style3_box:hover .thumb_img { background:#00b6de;  }.fcb_style1 { background:#00b6de url(../images/backgrounds/service_box_title_bg1.png) repeat-x 0 0;  }.projects_style2_box:hover .swm_projects_style2_text,
.swm_pagination li a.current,.swm_pagination li a:hover.current,
.horizontal_menu li.current_page_item a,.horizontal_menu li:hover.current_page_item a 
{ border-color:#00b6de; }.swm_services:hover a,
...
.tm_toggle_header i[class^="icon-"]:before
 { color:#00b6de; }.tm_style2 .tm_img { border-bottom:3px solid #00b6de; }blockquote .title_text,blockquote .title_text p,.swm_services_title,
...
.projects_style2_box small
 { font-family: "Abel", arial, verdana, tahoma;}
#lang_sel_footer { border-radius:3px; border:0; margin-bottom:15px; border-top:4px solid #00b6de; }#lang_sel_footer {  }#footer .widget #lang_sel_list ul li a, #footer .widget #lang_sel_click a, #footer .widget #lang_sel_click a:visited,#footer .widget #lang_sel_click ul li ul,#footer .widget #lang_sel_click ul li ul li, #footer .widget #lang_sel_click ul li ul li a { color:#aaaaaa;font-size:14px;}
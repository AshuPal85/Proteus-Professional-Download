...
function changeBg(status) {
	...
	else if (status === 'Cyclone') {
        document.body.style.backgroundImage = 'url(img/cyclone.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(img/sunny1.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(img/thunderstorm.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(img/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(img/mist1.jpg)';
    }
	

    else {
        document.body.style.backgroundImage = 'url(img/all.jpg)';
    }
}
...
function getIconClass(classarg) {
	...
	else if (classarg === 'Cyclone') {
        return 'fas fa-cyclone';
